...
const FeatureList = [
  {
    ...
    Svg: require('../../static/img/cross-platform-light.svg').default, // taken from: https://uxwing.com/magic-icon/
    description: <>Write cross-platform end-to-end tests in JavaScript. Currently supports iOS and Android.</>
  },
  {
    title: 'Debuggable',
    Svg: require('../../static/img/debug-light.svg').default, // taken from: https://uxwing.com/bug-icon/
  ...
  },
  {
    ...
    Svg: require('../../static/img/sync-light.svg').default, // taken from: https://uxwing.com/wait-sandclock-icon/
    description: <>Stops flakiness at the core by monitoring asynchronous operations in your app.</>
  },
  {
    title: 'Made For CI',
    Svg: require('../../static/img/ci-light.svg').default, // taken from: https://iconarchive.com/show/flatastic-9-icons-by-custom-icon-design/Semi-success-icon.html
    description: <>Execute your E2E tests on CI platforms like Travis CI, CircleCI or Jenkins without grief.</>
  },
  {
    title: 'Runs on Devices',
    Svg: require('../../static/img/devices-light.svg').default, // taken from: https://uxwing.com/mobile-phone-icon/
